...
public class IndeterminateRadialBar extends View {
    ...
    private void extractAttrs(AttributeSet attrs){
        ...
        try{
            ...
            backgroundColor = a.getColor(R.styleable.IndeterminateRadialBar_ibackgroundColor, mContext.getResources().getColor(R.color.accent_material_dark));
            fillColor = a.getColor(R.styleable.IndeterminateRadialBar_ifillColor, mContext.getResources().getColor(R.color.accent_material_light));
        }finally{
            a.recycle();
        }
    }
